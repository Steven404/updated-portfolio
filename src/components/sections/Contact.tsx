...
export function Contact() {
  ...
  const paraRef = useScrollFadeIn();
  const emailRef = useScrollFadeIn(0.1);
  const socialsRef = useScrollFadeIn(0.1);
    ...
    <section id="contact" className="py-24 bg-gray-800/50">
      <div className="container mx-auto px-4 text-center max-w-2xl">
        ...
        <p
          ...
          className="opacity-0 text-gray-400 text-lg mb-12 leading-relaxed"
        >
        ...
        <div
          ...
          className="opacity-0 flex flex-col sm:flex-row items-center justify-center mb-10"
        >
        ...
        <div
          ...
          className="opacity-0 flex items-center justify-center gap-6"
        >
          <a href="https://github.com/Steven404" target="_blank" rel="noopener noreferrer"
            className="text-gray-400 hover:text-white transition-colors p-2" aria-label="GitHub Profile">
            <Github size={28} />
          </a>
          <a href="https://www.linkedin.com/in/stefanos-michelakis-65884b230/" target="_blank" rel="noopener noreferrer"
            className="text-gray-400 hover:text-white transition-colors p-2" aria-label="LinkedIn Profile">
            <Linkedin size={28} />
          </a>
        </div>
      </div>
