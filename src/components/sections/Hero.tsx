  ...
  return (
    <section className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-20 bg-gray-900">
      <div className="container mx-auto px-4 text-center">
        <h1
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-6 text-white animate-fade-in-up"
          style={{ animationDelay: '0ms' }}
        >
          <span className="text-blue-500">Stefanos Michelakis</span>
        </h1>
        <p
          className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto mb-10 leading-relaxed animate-fade-in-up"
